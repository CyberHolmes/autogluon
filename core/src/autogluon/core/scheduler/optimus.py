...
class OptimusScheduler(TaskScheduler):
    ...
    >>> scheduler = ag.scheduler.OptimusScheduler(train_fn,
    ...
    def __init__(self, train_fn, **kwargs):
        ...
        assert_no_invalid_options(
            kwargs, _ARGUMENT_KEYS, name='OptimusScheduler')
    ...
    def schedule_next(self):
        ...
        if self._delay_get_config:
            ...
            OptimusScheduler.resource_manager._request(resources)
